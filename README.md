...
🖤 Engineering & CAD pack for BlackRoad OS
...
```bash
git clone https://github.com/BlackRoad-OS/blackroad-os-pack-engineering.git
cd blackroad-os-pack-engineering
```

## Documentation

- [BlackRoad OS Docs](https://docs.blackroad.io)
